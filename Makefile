...
BINARY = Simulator
OBJECTS = $(PATH_OBJECTS)/Core.o $(PATH_OBJECTS)/Log.o $(PATH_OBJECTS)/Main.o $(PATH_OBJECTS)/Program_Memory.o $(PATH_OBJECTS)/Register_File.o
...
$(PATH_OBJECTS)/Program_Memory.o: $(PATH_SOURCES)/Program_Memory.c $(PATH_INCLUDES)/Program_Memory.h
	$(CC) $(CCFLAGS) -c $< -o $@
