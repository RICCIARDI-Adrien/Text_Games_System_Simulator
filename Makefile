...
BINARY = Simulator
OBJECTS = $(PATH_OBJECTS)/Core.o $(PATH_OBJECTS)/Hex_Parser.o $(PATH_OBJECTS)/Log.o $(PATH_OBJECTS)/Main.o $(PATH_OBJECTS)/Peripheral_UART.o $(PATH_OBJECTS)/Program_Memory.o $(PATH_OBJECTS)/Register_File.o
...
$(PATH_OBJECTS)/Peripheral_UART.o: $(PATH_SOURCES)/Peripherals/Peripheral_UART.c $(PATH_INCLUDES)/Peripheral_UART.h
	$(CC) $(CCFLAGS) -c $< -o $@
