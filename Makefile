...
BINARY = Simulator
OBJECTS = $(PATH_OBJECTS)/Core.o $(PATH_OBJECTS)/Hex_Parser.o $(PATH_OBJECTS)/Log.o $(PATH_OBJECTS)/Main.o $(PATH_OBJECTS)/Peripheral_ADC.o $(PATH_OBJECTS)/Peripheral_Timer.o $(PATH_OBJECTS)/Peripheral_UART.o $(PATH_OBJECTS)/Program_Memory.o $(PATH_OBJECTS)/Register_File.o
...
$(PATH_OBJECTS)/Main.o: $(PATH_SOURCES)/Main.c $(PATH_INCLUDES)/Log.h $(PATH_INCLUDES)/Peripheral_Timer.h $(PATH_INCLUDES)/Peripheral_UART.h $(PATH_INCLUDES)/Register_File.h
	$(CC) $(CCFLAGS) -c $< -o $@
